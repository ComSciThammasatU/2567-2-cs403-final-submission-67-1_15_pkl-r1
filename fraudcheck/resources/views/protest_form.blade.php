    ...
    <div class="container my-5">
        <div class="card">
            <div class="card-body">
                ...
                <h4>หมายเลขรายงานที่แจ้ง: {{ $report->id }}</h4>  <!--แสดงเลขรายงาน-->
              
                <h4>หมายเลขผู้รายงาน: {{ Auth::user()->id }}</h4> <!--แสดงเลขรายงาน-->

                <!--ส่งไป Route::post('protest.store')-->
                <form action="{{ route('protest.store', $report->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf <!--ป้องกันการส่ง request จากที่อื่น-->
                    <div class="mb-4">

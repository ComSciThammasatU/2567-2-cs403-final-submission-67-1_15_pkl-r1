                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/verify-otp" method="POST">
                            <?php echo csrf_field(); ?> <!--ป้องกัน request จากเว็บอื่น-->
                            <div class="mb-4">
...
unset($__errorArgs, $__bag); ?>" id="otp" name="otp" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!--ส่ง OTP ซ้ำ-->
                 <form action="<?php echo e(route('otp.resend')); ?>" method="POST" class="mt-3 text-center">
                     <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\fraudcheck\fraudcheck\resources\views/otp.blade.php ENDPATH**/ ?>
...
<body>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="changePasswordForm" action="<?php echo e(route('updatepassword')); ?>" method="POST">
                            <?php echo csrf_field(); ?> <!--ป้องกันการรับ request จากภายนอก-->
                            <?php echo method_field('PUT'); ?> <!--ใช้ put เพื่อแก้ไข-->
                            <div class="mb-4">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            var errorModal = new bootstrap.Modal(document.getElementById('errorModal'));
            document.getElementById('errorModalBody').textContent = <?php echo json_encode(session('error')); ?>;
            errorModal.show(); //แสดง
        });
        </script>
        <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\fraudcheck\fraudcheck\resources\views/editpassword.blade.php ENDPATH**/ ?>